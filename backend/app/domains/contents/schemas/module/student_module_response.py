...
from app.domains.contents.schemas.chapters.student_chapter_detail_response import StudentChapterDetailResponse, StudentChapterDetailWithoutBlockResponse
...
class StudentModuleResponse(ModuleResponse):
    ...
    chapters: list[StudentChapterDetailWithoutBlockResponse]

class StudentModuleWithoutChaptersResponse(ModuleResponse):    
    progress: ModuleProgressResponse | None = Field(
        default=None, 
        validation_alias="module_progress"
    )

...
def upgrade() -> None:
    """Upgrade schema."""
    # pg_trgm menyediakan operator class gin_trgm_ops yang dipakai index idx_modules_title_trgm
    # di bawah -- extension ini harus aktif dulu sebelum index itu dibuat.
